...
int ACA_Dataplane_Mizar::execute_command(int command, void *input_struct, ulong &culminative_time)
{
  CLIENT *client;
  int rc = EXIT_SUCCESS;
  int *transitd_return;
...
int ACA_Dataplane_Mizar::load_agent_xdp(string interface, ulong &culminative_time)
{
  int rc;
...
int ACA_Dataplane_Mizar::unload_agent_xdp(string interface, ulong &culminative_time)
{
  int rc;
  rpc_intf_t inf_in;
  char inf[20];
