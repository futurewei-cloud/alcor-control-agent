...
void GoalStateProvisionerAsyncServer::CallData()
{
...
void GoalStateProvisionerAsyncServer::ProcessMessage(PushGoalStatesStreamAsyncCall *streamingCall)
{
       ...
       AsyncGoalStateProvionerCallBase *baseCall, bool ok)
{
   ...
   case AsyncGoalStateProvionerCallBase::CallStatus::INIT:
       ...
       CallData();
       streamingCall->status_ = AsyncGoalStateProvionerCallBase::CallStatus::PROCESS;
       ACA_LOG_DEBUG("%s\n", "This call needs to read from the stream first");
       streamingCall->stream_.Read(&streamingCall->goalStateV2_, baseCall);
       break ;
   case AsyncGoalStateProvionerCallBase::CallStatus::PROCESS:
       ACA_LOG_DEBUG("%s\n", "Processing a PushGoalStateStream call...");
       ProcessMessage(streamingCall);
