...
. program the openflow rule on br-tun so that matching VNI traffic can be sent from physical NIC to this new port
...
- [[[rfc7047,6]]] https://tools.ietf.org/html/rfc7047