...
image::images/ovs_all2.jpg["OVS Component diagram", width=800, link="images/ovs_all2.jpg"]
click here <<original-pptx>> for the orginal file
...
- [[[original-pptx,-1]]] https://github.com/er1cthe0ne/alcor-control-agent/blob/docs/design/docs/images/ovs-all.pptx
- [[[pending-items,1]]] https://github.com/er1cthe0ne/alcor-control-agent/blob/docs/design/docs/pending-items.adoc
