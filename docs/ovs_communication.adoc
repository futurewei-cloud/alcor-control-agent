...
The command to enable encap/decap is - "ovs-vsctl add-port set interface type=vxlan"
...
Some of the major OVS feature needed by Alcor network control plan includes: <<why-ovs>>
...
- [[[cidl,5]]] http://docs.openvswitch.org/en/latest/topics/idl-compound-indexes/