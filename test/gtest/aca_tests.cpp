...
TEST(net_config_test_cases, setup_veth_device_invalid)
{
	...
	rc = Aca_Net_Config::get_instance().setup_veth_device(
		EMPTY_STRING, VALID_STRING, VALID_STRING, VALID_STRING,
		VALID_STRING, VALID_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);

	rc = Aca_Net_Config::get_instance().setup_veth_device(
		VALID_STRING, EMPTY_STRING, VALID_STRING, VALID_STRING,
		VALID_STRING, VALID_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);

	rc = Aca_Net_Config::get_instance().setup_veth_device(
		VALID_STRING, VALID_STRING, EMPTY_STRING, VALID_STRING,
		VALID_STRING, VALID_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);

	rc = Aca_Net_Config::get_instance().setup_veth_device(
		VALID_STRING, VALID_STRING, VALID_STRING, EMPTY_STRING,
		VALID_STRING, VALID_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);

	rc = Aca_Net_Config::get_instance().setup_veth_device(
		VALID_STRING, VALID_STRING, VALID_STRING, VALID_STRING,
		EMPTY_STRING, VALID_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);

	rc = Aca_Net_Config::get_instance().setup_veth_device(
		VALID_STRING, VALID_STRING, VALID_STRING, VALID_STRING,
		VALID_STRING, EMPTY_STRING);
	ASSERT_NE(rc, EXIT_SUCCESS);
}
...
TEST(net_config_test_cases, setup_veth_device_valid)
{
	...
	rc = Aca_Net_Config::get_instance().setup_veth_device(test_ns, veth, ip,
							      prefix, mac, gw);
	EXPECT_EQ(rc, EXIT_SUCCESS);
