...
int main(int argc, char *argv[])
{
       ...
       // this will allocate new SubnetConfiguration_TransitSwitch, may to free it later
       ...
       // this will allocate new VpcConfiguration_TransitRouter, may to free it later
